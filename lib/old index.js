(function (global, factory) {
 ...
 // function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
  ...
  function _genTextContextMatrix() {
    _genTextContextMatrix = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(path) {
      var options,
        onProgress,
        start,
        end,
  ...
  function _genXlsx() {
    _genXlsx = _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(pdfPath, xlsxPath, options) {
